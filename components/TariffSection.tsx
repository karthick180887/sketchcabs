...
const tariffs = [
    { name: 'Mini', type: 'Mini (3+1)', fuel: 'Petrol', seats: 4, luggage: 0, price: '₹12' },
    { name: 'Sedan', type: 'Sedan (4+1)', fuel: 'Petrol', seats: 4, luggage: 3, price: '₹13' },
    { name: 'Etios', type: 'Etios (4+1)', fuel: 'Petrol', seats: 5, luggage: 3, price: '₹14' },
    { name: 'Sedan (Non-CNG)', type: 'Sedan (4+1)', fuel: 'Petrol', seats: 5, luggage: 0, price: '₹14' },
    { name: 'SUV', type: 'SUV (7+1)', fuel: 'Petrol', seats: 8, luggage: 4, price: '₹18' },
    { name: 'Innova', type: 'Innova (6+1)', fuel: 'Petrol', seats: 7, luggage: 4, price: '₹19' },
    { name: 'Innova Crysta', type: 'Crysta (6+1)', fuel: 'Diesel', seats: 7, luggage: 4, price: '₹25' },
];
